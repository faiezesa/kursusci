    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="info">
          ...
          <a href="<?php echo base_url(); ?>/logout" class="text-muted"><i class="fas fa-power-off"></i> Logout</a>
        </div>
      </div>
...
<?php /**PATH C:\Apache24\htdocs\kursusci\app\Views/default/side-menu.blade.php ENDPATH**/ ?>